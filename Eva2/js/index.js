firebase.initializeApp({
  ...
  <td><button class="btn btn-danger" onclick="editar('${doc.id}','${doc.data().Nombre}','${doc.data().Categoria}','${doc.data().Tipo}','${doc.data().Plataforma}','${doc.data().Descripcion}','${doc.data().Ubicacion}','${doc.data().Estado}')">Editar</button></td>
  </tr>
  `
      });
    });
